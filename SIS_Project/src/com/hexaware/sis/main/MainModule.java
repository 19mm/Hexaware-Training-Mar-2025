...
public class MainModule {
    ...
    public static void main(String[] args) {
        // Establish DB connection to ensure connectivity is working.
    ...
    private static void enrollStudentInCourse(Scanner scanner) {
        ...
        // Use 0 as a dummy enrollmentId since it will be auto-generated by the database.
 ...
 // Task 2.5 / Task 9: Assign Teacher to Course
    private static void assignTeacherToCourse(Scanner scanner) {
        ...
        // Update the course object with the assigned teacher.
 ...
 // Task 2.6: Delete a Student and all their Enrollments
    private static void deleteStudentAndEnrollments(Scanner scanner) {
        ...
        try {
            // First, delete all enrollments for this student from the Enrollments table.
 ...
 // Task 2.7: Update Payment Amount for a Payment Record
    private static void updatePaymentAmount(Scanner scanner) {
        ...
        // Call the DAO update method to update the record in the database.
    ...
    private static void generateTotalPaymentsForStudent(Scanner scanner) {
        ...
        int studentId = scanner.nextInt();
        scanner.nextLine();
        // Optionally, verify the student exists
        Student student = studentDAO.getStudent(studentId);
        if (student == null) {
            throw new StudentNotFoundException("Student not found with ID: " + studentId);
        }
        // Retrieve payments from PaymentDAO rather than student's empty history.
